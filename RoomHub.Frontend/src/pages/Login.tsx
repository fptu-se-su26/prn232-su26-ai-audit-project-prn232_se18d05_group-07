...
const Login: React.FC = () => {
  ...
  // Google Login via @react-oauth/google (popup flow → id_token → backend)
  const handleGoogleLogin = useGoogleLogin({
    ...
    onSuccess: async (tokenResponse) => {
      ...
      setError(null);
      try {
        // Gửi access_token lên backend để verify và tạo JWT
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full h-11 border border-gray-300 rounded-lg flex items-center justify-center gap-3 hover:bg-gray-50 transition bg-white disabled:bg-gray-100 disabled:cursor-not-allowed"
              >
                {isGoogleLoading ? (
