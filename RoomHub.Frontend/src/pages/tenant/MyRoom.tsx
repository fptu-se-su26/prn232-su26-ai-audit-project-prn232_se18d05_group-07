...
const TenantMyRoom: React.FC<Props> = ({ setCurrentPage }) => {
  ...
  const handleDownloadContract = async () => {
    try {
      ...
      await contractDocumentApi.downloadMyContract();
    } catch {
      alert('Không tải được hợp đồng. Vui lòng thử lại.');
    } finally {
          ...
          <Reveal>
            <div className="bg-white rounded-2xl border border-gray-100 soft-shadow p-6">
              ...
              <button
                ...
                className="w-full mt-2 py-2.5 bg-white hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed text-gray-600 rounded-xl text-xs font-bold transition-all flex items-center justify-center gap-2 cursor-pointer border border-gray-200"
              >
