...
const VerifyOtp: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (savedEmail) {
      ...
      // If no email saved, redirect back to Register
      navigate('/register');
    }
  }, [navigate]);
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] flex font-sans">
      {/* LEFT FORM */}
      <div className="w-full lg:w-1/2 flex flex-col justify-between p-12 bg-white relative">
        <div className="w-full max-w-md mx-auto flex-1 flex flex-col justify-center pb-20 mt-16">
          <div className="mb-10">
            <h1 className="text-4xl font-bold mb-3">Xác thực email</h1>
