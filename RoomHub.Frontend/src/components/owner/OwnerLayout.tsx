...
const OwnerLayout: React.FC<OwnerLayoutProps> = ({ currentPage, setCurrentPage, children }) => {
  ...
  const getPageInfo = () => {
    switch (currentPage) {
      ...
      case 'owner-service-requests':
        return { title: 'Yêu cầu dịch vụ', subtitle: 'Yêu cầu dịch vụ từ khách thuê của bạn.' };
      default:
  ...
  const menuItems = [
    ...
    { label: 'Yêu cầu dịch vụ', icon: 'room_service', route: 'owner-service-requests' as PageType },
    ...
    { label: 'Báo cáo & Thống kê', icon: 'analytics', route: 'owner-reports' as PageType },
