...
namespace RoomHub.Infrastructure.Migrations
{
    ...
    [Migration("20260727005821_AddContractReminderLog")]
    partial class AddContractReminderLog
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.ContractReminderLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ContractId", "MilestoneDays")
                        .IsUnique();

                    b.ToTable("ContractReminderLogs", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.Deposit", b =>
                {
                    ...
                    b.Property<int?>("ActiveHoldRoomId")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("int")
                        .HasComputedColumnSql("CASE WHEN [Status] IN ('Holding','Active') THEN [RoomId] ELSE NULL END", true);
            ...
            modelBuilder.Entity("Domain.Entities.DepositPaymentProof", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("DepositPaymentProofs", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.ReviewRevision", b =>
                {
                    ...
                    b.Property<string>("NewModerationStatus")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");

                    b.Property<byte?>("NewRating")
                        .HasColumnType("tinyint");
                    ...
                    b.Property<string>("PreviousModerationStatus")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");

                    b.Property<byte?>("PreviousRating")
                        .HasColumnType("tinyint");
            ...
            modelBuilder.Entity("Domain.Entities.DepositPaymentProof", b =>
                {
                    b.HasOne("Domain.Entities.Deposit", "Deposit")
                        ...
                        .HasForeignKey("Domain.Entities.DepositPaymentProof", "DepositId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("Domain.Entities.ReviewRevision", b =>
                {
                    b.HasOne("Domain.Entities.ApplicationUser", "EditedByUser")
                        .WithMany()
