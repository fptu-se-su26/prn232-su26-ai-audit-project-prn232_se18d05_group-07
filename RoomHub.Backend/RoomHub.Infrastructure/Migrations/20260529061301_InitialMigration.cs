        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleSpecificData = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    IsBanned = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    ReviewBlockedUntil = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommissionRate = table.Column<decimal>(type: "decimal(5,2)", nullable: false, defaultValue: 0.10m)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<int>(type: "int", nullable: false),
                    DefaultHoldDurationDays = table.Column<int>(type: "int", nullable: false, defaultValue: 3),
                    DefaultDepositPercent = table.Column<decimal>(type: "decimal(5,2)", nullable: false, defaultValue: 50.00m),
                    PlatformCommissionRate = table.Column<decimal>(type: "decimal(5,2)", nullable: false, defaultValue: 10.00m),
                    MaxRoomsPerBuilding = table.Column<int>(type: "int", nullable: false, defaultValue: 500),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InternetPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    GarbagePrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransactionProofUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CCCDNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    PassportNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    IdentityDocumentPath = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
                    SelfiePath = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
                    RentalHistory = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxCapacity = table.Column<int>(type: "int", nullable: false, defaultValue: 2),
                    SurfaceArea = table.Column<decimal>(type: "decimal(6,2)", nullable: true),
                    BasePrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
                    IsFurnished = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    ...
                    InternetPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    GarbagePrice = table.Column<decimal>(type: "decimal(18,2)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OwnerId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    TemporaryTenantName = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    TemporaryTenantPhone = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    TemporaryTenantEmail = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    ...
                    Status = table.Column<string>(type: "varchar(20)", nullable: false),
                    SignaturePath = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    HoldDurationDays = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Deposits_AspNetUsers_TenantId",
                        column: x => x.TenantId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "varchar(20)", nullable: false),
                    Sentiment = table.Column<string>(type: "varchar(20)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaintenanceTickets_AspNetUsers_AssignedTo",
                        column: x => x.AssignedTo,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MaintenanceTickets_AspNetUsers_TenantId",
                        column: x => x.TenantId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsModerated = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ViewedRoomId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SearchHistories_Rooms_ViewedRoomId",
                        column: x => x.ViewedRoomId,
                        principalTable: "Rooms",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "varchar(20)", nullable: false),
                    PaymentProofPath = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Content = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Images = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LinkedRoomId = table.Column<int>(type: "int", nullable: true),
                    LinkedContractId = table.Column<int>(type: "int", nullable: true),
                    IsModerated = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    ModerationReason = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Messages_Contracts_LinkedContractId",
                        column: x => x.LinkedContractId,
                        principalTable: "Contracts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Messages_Rooms_LinkedRoomId",
                        column: x => x.LinkedRoomId,
                        principalTable: "Rooms",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UtilityType = table.Column<string>(type: "varchar(20)", nullable: false),
                    OldIndex = table.Column<decimal>(type: "decimal(12,2)", nullable: true),
                    NewIndex = table.Column<decimal>(type: "decimal(12,2)", nullable: true),
                    Usage = table.Column<decimal>(type: "decimal(12,2)", nullable: true),
                    Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UtilityReadings_Contracts_ContractId",
                        column: x => x.ContractId,
                        principalTable: "Contracts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    ProofPath = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, "Air Conditioning" },
                    { 2, null, "WiFi" },
                    { 3, null, "Refrigerator" },
                    { 4, null, "Washing Machine" },
                    { 5, null, "Kitchen" },
                    { 6, null, "Parking" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "admin-role-id", "1", "Administrator", "ADMINISTRATOR" },
                    { "owner-role-id", "2", "PropertyOwner", "PROPERTYOWNER" },
                    { "tenant-role-id", "3", "Tenant", "TENANT" }
                });

            migrationBuilder.InsertData(
                table: "SystemSettings",
                columns: new[] { "Id", "DefaultDepositPercent", "DefaultHoldDurationDays", "MaxRoomsPerBuilding", "PlatformCommissionRate", "UpdatedAt" },
                values: new object[] { 1, 50.00m, 3, 500, 10.00m, null });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceTickets_AssignedTo",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Messages_LinkedContractId",
                table: "Messages",
                column: "LinkedContractId");

            migrationBuilder.CreateIndex(
                name: "IX_Messages_LinkedRoomId",
                table: "Messages",
                column: "LinkedRoomId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rooms_Status_Price",
                table: "Rooms",
                columns: new[] { "Status", "BasePrice" });

            migrationBuilder.CreateIndex(
                name: "UQ_RoomPerFloor",
                table: "Rooms",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SearchHistories_ViewedRoomId",
                table: "SearchHistories",
                column: "ViewedRoomId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UtilityReadings_ContractId",
